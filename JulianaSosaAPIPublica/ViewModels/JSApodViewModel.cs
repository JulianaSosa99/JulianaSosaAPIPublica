...
using JulianaSosaAPIPublica.Services;
using System;
...
namespace JulianaSosaAPIPublica.ViewModels
{
    public class JSApodViewModel : INotifyPropertyChanged
    {
        ...
        private JSApodService service;
        public JSApodService Service
        {
            get
            {
                if (service == null)
                {
                    service = new JSApodService();
                }
                return service;
            }
        }
        ...
        {
            JSApod dto = await Service.GetImage(day);
            if (dto == null)
            {
